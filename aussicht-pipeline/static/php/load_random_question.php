...
<div class="lp-exhibitiontext" id="jump2top">
    <p>
    <span id="type-questions" class="typewriter"></span> Aus heutiger Sicht. Diskurse <br> über Zukunft.<br>
    12.03.-16.03
    </p>
</div>
    ...
    document.addEventListener('DOMContentLoaded',function(event){
        ...
        function typeWriter(text, i, fnCallback) { 
            ...
            if (i < (text.length)) {
                ...
                document.getElementById("type-questions").innerHTML = text.substring(0, i+1) +'<span class="typewriter" aria-hidden="true"></span>';
